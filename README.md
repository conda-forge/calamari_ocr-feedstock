About calamari_ocr-feedstock
============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/calamari_ocr-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3780&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/calamari_ocr-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `calamari_ocr` can be installed with `conda`:
...
```
mamba install calamari_ocr
```

It is possible to list all of the versions of `calamari_ocr` available on your platform with `conda`:
...
```
mamba search calamari_ocr --channel conda-forge
```
...
mamba repoquery search calamari_ocr --channel conda-forge

# List packages depending on `calamari_ocr`:
mamba repoquery whoneeds calamari_ocr --channel conda-forge

# List dependencies of `calamari_ocr`:
mamba repoquery depends calamari_ocr --channel conda-forge
```
